...
/*   Updated: 2024/07/24 08:08:56 by hshimizu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	make_coeff(t_cylinder *self, const t_ray *ray, float coeff[3])
{
	...
	coeff[2] = pow(local_ray.c._[0], 2) + pow(local_ray.c._[2], 2) - 1;
}

static inline int	check_height(t_cylinder *self, const t_ray *ray, float k)
{
	t_abstract_figure *const	figure = (void *)self;
	const float					height = \
